...
#############################################################################
#first we get the mean of each year and then plot a box plot which shows variation in inter-annual variation
...
write_csv(RoLandRoNPP_df,"data/RoverL&RoverANPP_modelPredictions.csv")
